...
predict_Winner<-function(home,away)
{
  ...
  #getting their scored and conceded goals average in home and away
  scored=as.double(df_team_strength[HomeRowIndex,2])
  #conceded=as.double(df_team_strength[AwayRowIndex,3])
  
  #lamb_home = as.double(scored*conceded)
  lamb_home = as.double(scored)
  
  scored=as.double(df_team_strength[AwayRowIndex,2])
  #conceded=as.double(df_team_strength[HomeRowIndex,3])
  
  #lamb_away = as.double(scored*conceded)
